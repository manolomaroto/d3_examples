 ...
 */
 ...
 window.onload = search();
                ...
                d3.select('#tasa').html(trimestres[trimestres.length - 1].substring(5));
                ...
                */
                ...
                d3.csv("historico.csv", function(data) {
                    d3.json("Provincias.json", function(json) {
                        d3.json("canarian.json", function(can) {
                            ...
                            d3.select("#control")
                                    .on("input", function() {
                                        d3.select('#tasa').html(trimestres[inp.value].substring(5));
                ...
                var escalaX = d3.time.scale()
                        .domain([new Date(2005, 0, 1), new Date(2014, 5, 1)])
                        .range([0, width]);
